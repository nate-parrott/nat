...
//        try ChatGPT(credentials: .init(apiKey: openrouterKey()), options: .init(temp: 1, model: .custom("deepseek/deepseek-r1", 64_000), printToConsole: true, baseURL: .openRouterOpenAIChatEndpoint))
